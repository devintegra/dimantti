...
$qdestino = "SELECT * FROM ct_sucursales WHERE estado = 1";

if (!$rdestino = $mysqli->query($qdestino)) {
    echo "Lo sentimos, esta aplicación está experimentando problemas.";
    exit;
}
#endregion
...
<body>
                                        ...
                                        <div class="col-sm-12 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <select class='form-control' id='movimiento'>
                                                    ...
                                                    <option value="7">Devoluciones de venta</option>
                                                    <option value="8">Devoluciones por cancelación de venta</option>
                                                    <option value="9">Recepción de productos desde transferencia</option>
                                                    <option value="10">Devoluciones de transferencia</option>
                                                    <option value="11">Devoluciones de prestamo</option>
                                                    <option value="12">Ventas de prestamo</option>
                                                </select>
                                            </div>
                                        </div>
    ...
    <script src="custom/reporteMovimientos.js"></script>
