...
<body>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title">Reporte de traspasos</h4>
                                        ...
                                        <div class="col-sm-12 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <select class='form-control' id='destino'>
                                                    <option value="0">Todas</option>
                                                    <?php
                                                    while ($destino = $rdestino->fetch_assoc()) {
                                                        echo "<option value='$destino[pk_sucursal]'>$destino[nombre]</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </div>
    ...
    <script src="custom/reporteTraspasos.js"></script>
