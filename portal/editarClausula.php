...
if (isset($_GET['id']) && is_string($_GET['id'])) {
    $pk_clausula = (int)$_GET['id'];
}


$mysqli->next_result();
if (!$rclausula = $mysqli->query("CALL sp_get_clausula($pk_clausula)")) {
    echo "<br>Lo sentimos, esta aplicación está experimentando problemas.1";
    exit;
}

$row = $rclausula->fetch_assoc();
...
<body>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title">Editar cláusula</h4>
                            <i class='bx bx-message-alt-error' style="font-size:32px"></i>
                        </div>
                        <form class="forms-sample" enctype="multipart/form-data" id="formuploadajax">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="descripcion" class="d-flex justify-content-start align-items-center"> <i class='bx bx-edit-alt fs-4'></i> Descripción</label>
                                        <?php
                                        echo "<textarea class='form-control' id='descripcion' cols='30' rows='10' style='height: 300px;' placeholder='Escribe aquí el detalle de la cláusula...'>$descripcion</textarea>
                                        <input type='hidden' id='pk_clausula' name='pk_clausula' class='form-control' value='$pk_clausula'>";
                                        ?>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="custom/editarClausula.js"></script>
