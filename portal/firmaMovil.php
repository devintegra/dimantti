...
<body style="max-width: 100%; overflow: hidden">
    ...
    <ul style="font-size: 1em">
        <li>Firma de consentimiento del cliente</li>
    </ul>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <?php echo "  <a target='_blank' id='pdf' href='ordenPDF.php?id=$id' class='btn btn-danger pdfb'><i class='fa fa-file-pdf-o fa-5x' aria-hidden='true'></i><br><br>DESCARGAR ORDEN</a>"; ?>
                ...
                <div class="modal-footer text-center">
                    <div class="col-sm-12">
                        <button onclick="ver()" id="ver" type="button" class="btn btn-sm btn-info">Ver órdenes</button>
                        <button onclick="nueva()" id="nueva" type="button" class="btn btn-sm btn-warning">Generar Nueva Orden</button>
                        <button onclick="inicio()" id="inicio" type="button" class="btn btn-sm btn-success">Inicio</button>
                        <button onclick="fotos()" id="fotos" type="button" class="btn btn-sm btn-primary">Fotos</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function guardar() {
            ...
            xhr.open('POST', 'servicios/upload_data.php', true);
        ...
        function nueva() {
            jQuery(location).attr("href", "agregarOrden.php");
        }
