                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="agregarSucursal.php"><button type="button" class="btn btn-social-icon-text btn-add"><i class='bx bx-plus'></i>Nueva sucursal</button></a>
                        </div>

                        <div class="table-responsive overflow-hidden">

                            <?php
                            $eusuario = "select * from ct_sucursales where estado=1";


                            echo "<table id=\"dtEmpresa\" class=\"table table-striped\">
                                        <thead>
                                            <tr>
                                                <th>Nombre</th>
                                                <th>Teléfono</th>
                            ...
                            while ($roweusuario = $resultado->fetch_assoc()) {
                                ...
                                echo "<tr class=\"odd gradeX\">
                                                    <td><a style='text-decoration:none' href='editarSucursal.php?id=$roweusuario[pk_sucursal]'>$roweusuario[nombre]</a></td>
                                                    <td><a style='text-decoration:none' href='editarSucursal.php?id=$roweusuario[pk_sucursal]'>$roweusuario[telefono]</a></td>
                                                    <td><a style='text-decoration:none' href='editarSucursal.php?id=$roweusuario[pk_sucursal]'>$roweusuario[correo]</a></td>
                                        </tr>";
                            }
