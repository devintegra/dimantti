                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title">Motivos de salida</h4>
                            <a href="agregarMotivoSalida.php"><button type="button" class="btn btn-social-icon-text btn-add"><i class='bx bx-plus'></i>Nuevo motivo de salida</button></a>
                        </div>
                        <div class="table-responsive overflow-hidden">
                            ...
                            echo "
                                <table id='dtOrigenes' class='table table-striped text-center'>
                                    ...
                                    <tbody>";
                            if (!$resultado = $mysqli->query($qmotivo)) {
                                echo "Lo sentimos, esta aplicación está experimentando problemas.";
                                exit;
                            }
                            while ($rmotivo = $resultado->fetch_assoc()) {
                                echo "
                                        <tr>
                                            <td>
                                                <a style='text-decoration:none;' href='editarMotivoSalida.php?id=$rmotivo[pk_motivo_salida]'>$rmotivo[nombre]</a>
                                            </td>
                                        </tr>";
                            }
                            echo "
