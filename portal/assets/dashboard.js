(function($) {
  ...
  $(function() {
    if ($("#performaneLine").length) {
      ...
      saleGradientBg2.addColorStop(0, 'rgba(0, 0, 0, 0.19)');
      saleGradientBg2.addColorStop(1, 'rgba(0, 0, 0, 0.03)');
      var salesTopData = {
          ...
          datasets: [{
              ...
              pointBackgroundColor: ['#000)', '#000', '#000', '#000','#000)', '#000', '#000', '#000','#000)', '#000', '#000', '#000','#000)'],
            ...
            pointBackgroundColor: ['#6c7383)', '#6c7383', '#6c7383', '#6c7383','#6c7383)', '#6c7383', '#6c7383', '#6c7383','#6c7383)', '#6c7383', '#6c7383', '#6c7383','#6c7383)'],
              pointBorderColor: ['#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff',],
        }]
      };
