...
if (isset($_GET['id']) && is_string($_GET['id'])) {
    $pk_presentacion = (int)$_GET['id'];
}


$qpresentacion = "SELECT * FROM ct_presentaciones WHERE pk_presentacion = $pk_presentacion";

if (!$rpresentacion = $mysqli->query($qpresentacion)) {
    echo "<br>Lo sentimos, esta aplicación está experimentando problemas.1";
    exit;
}

$rowp = $rpresentacion->fetch_assoc();
$nombre = $rowp["descripcion"];
...
<body>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title">Editar presentación</h4>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <?php
                                        echo <<<HTML
                                            <input type='text' id='nombre' name='nombre' placeholder='Ej.Chica' class='form-control' value='$nombre' autocomplete='off'>
                                            <input type='hidden' id='pk_presentacion' name='pk_presentacion' class='form-control' value='$pk_presentacion'>
                                        HTML;
                                        ?>
                                    </div>
                                </div>
    ...
    <script src="custom/editarPresentacion.js"></script>
