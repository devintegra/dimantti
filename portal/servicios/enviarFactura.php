...
$qfactura = "SELECT * FROM tr_facturas WHERE pk_factura = '$uuid' AND estado = 1";
...
$factura = $rfactura->fetch_assoc();
$id = $factura["pk_factura"];
$factura_fk_cliente = $factura["fk_cliente"];
...
//CLIENTE
$qcliente = "SELECT * FROM ct_clientes WHERE pk_cliente = $factura_fk_cliente";
...
//EMPRESA
$qempresa = "SELECT * FROM ct_empresas WHERE pk_empresa = 1 AND estado = 1";
...
$rowe = $rempresa->fetch_assoc();
$empresa_nombre = $rowe["nombre"];
...
$txtInfo = "<html
        ...
        <head>
            ...
            <title>Cotización #$cotizacion_folio</title>
        ...
        <body
            ...
            <table class='es-wrapper' width='100%' cellspacing='0' cellpadding='0'
                ...
                <td valign='top' style='padding:0;Margin:0;'>
                    ...
                    <tr style='border-collapse:collapse;'>
                        <td
                        style='padding:0;Margin:0;background-position:center top;background-repeat:no-repeat;background-size:cover;background-image: linear-gradient(to bottom, #ffecd2 0%, #fcb69f 100%);'
                        align='center'>
                                ...
                                <tr style='border-collapse:collapse;'>
                                    ...
                                    <table width='100%' cellspacing='0' cellpadding='0'
                                        ...
                                        <td align='center' style='padding:5px;Margin:0;'>
                                            ...
                                            <strong>$empresa_nombre</strong></p>
                                        </td>
                                        </tr>
                                        <tr style='border-collapse:collapse;'>
                                        <td style='height: 50px'></td>
                                ...
                                <tr style='border-collapse:collapse;'>
                                    ...
                                    <table
                                        ...
                                        <td align='center'
                                            ...
                                            Hola, por este medio le compartimos el archivo PDF de su factura
                                            </span>
                                            </p>
                                        </td>
                                        </tr>
                                        ...
                                        <td align='center' style='padding:0;Margin:0;'>
                                            ...
                                            <strong>Datos de la factura: &nbsp;</strong></p>
                                            <ul>
                                            <li
                                            ...
                                            <li
                                                style='-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family: helvetica, arial, sans-serif;line-height:24px;Margin-bottom:15px;color:#696969;text-align:left;'>
                                                <strong>Descripción: </strong>$factura_descripcion
                                            </li>
                                            <li
                                                style='-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family: helvetica, arial, sans-serif;line-height:24px;Margin-bottom:15px;color:#696969;text-align:left;'>
                                                <strong>Fecha de expedición: </strong>$factura_fecha
                                            </li>
                                            <li
                                                style='-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family: helvetica, arial, sans-serif;line-height:24px;Margin-bottom:15px;color:#696969;text-align:left;'>
                                                <strong><a href='$factura_pdf' download>Descargar factura PDF</a></strong>
                                            </li>
                                            <li
                                                style='-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family: helvetica, arial, sans-serif;line-height:24px;Margin-bottom:15px;color:#696969;text-align:left;'>
                                                <strong><a href='$factura_xml' download>Descargar factura XML</a></strong>
                                            </li>
                                            </ul>
                                            <br>
                                            <br>
                                        ...
                                        <tr style='border-collapse:collapse;'>
                                            <td style='text-align: center;'>Agradecemos su preferencia. Estamos para servirle.</td>
                                        </tr>
                                    </table>
                                    </td>
                                </tr>
