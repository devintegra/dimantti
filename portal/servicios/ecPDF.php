...
function addTotal($total)
{
    ...
    $this->SetXY( $x1, $y1 );
    $this->SetFont('Arial','B',12);
    $this->Cell(26,10,'Total',1,0,'C');
    $this->SetXY( $x1+26, $y1 );
    $this->SetFont('Arial','B',12);
    $this->Cell(30,10,$total,1,0,'R');
...
function addTotalb($total)
{
    ...
    $this->SetXY( $x1+25, $y1 );
    $this->SetFont('Arial','B',12);
    $this->Cell(35,10,$total,1,0,'R');
    
}


function addTotalbp($total)
{
...
function addTotalbnp($total)
{
    ...
    $this->SetXY( $x1, $y1 );
    $this->SetFont('Arial','B',12);
    $this->Cell(25,10,'No pagadas',1,0,'C');
    $this->SetXY( $x1+25, $y1 );
    $this->SetFont('Arial','B',12);
    $this->Cell(35,10,$total,1,0,'R');
...
function addImage($imagen, $ancho, $alto)
{
    $x1 = 11;
    $y1 = 33;
