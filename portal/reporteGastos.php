...
//TIPOS DE RETIRO
#region
$qretiros = "SELECT * FROM ct_retiros WHERE estado = 1";
...
<body>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <select class='form-control' id='gasto'>
                                                    <option value="0">Todos</option>
                                                    <?php
                                                    while ($retiros = $rretiros->fetch_assoc()) {
                                                        echo "<option value='$retiros[pk_retiro]'>$retiros[nombre]</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-sm-12 col-lg-4">
                                            <div class="form-group">
                                                <label for="usuario"><i class='bx bx-user fs-5'></i>Usuario</label>
    ...
    <script src="custom/reporteGastos.js"></script>
