...
$qpresentaciones = "SELECT * FROM ct_presentaciones WHERE estado = 1";

if (!$rpresnetaciones = $mysqli->query($qpresentaciones)) {
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title">Presentaciones del producto</h4>
                            <div class="d-flex gap-2">
                                <a href="agregarPresentacion.php"><button type="button" class="btn btn-social-icon-text btn-add"><i class='bx bx-plus'></i>Nueva presentación</button></a>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive overflow-hidden">
                                <table id='dtEmpresa' class='table table-striped text-center'>
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = $rpresnetaciones->fetch_assoc()) {

                                            echo <<<HTML
                                                <tr class='odd gradeX'>
                                                    <td>
                                                        <a href='editarPresentacion.php?id=$row[pk_presentacion]'>$row[pk_presentacion]</a>
                                                    </td>
                                                    <td>
                                                        <a href='editarPresentacion.php?id=$row[pk_presentacion]'>$row[descripcion]</a>
                                                    </td>
                                                </tr>
                                            HTML;
                                        }
