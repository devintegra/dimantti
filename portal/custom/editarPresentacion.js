...
$("#guardar").click(function () {
    ...
    if (validar()) {
        ...
        formData.append("pk_presentacion", $("#pk_presentacion").val());
        formData.append("nombre", $("#nombre").val());

        $.ajax({
            url: "servicios/editarPresentacion.php",
            type: "post",
            dataType: "html",
            data: formData,
            cache: false,
            ...
            success: function (response) {
                ...
                if (response.codigo == 200) {
                    ...
                    swal("Enviado", "El registro se guardó correctamente", "success").then(function () {
                        $(location).attr("href", "verPresentaciones.php");
                    });
...
$("#eliminar").click(function () {
    Swal.fire({
        ...
        text: "¿Estás seguro que deseas eliminar la presentación?",
        icon: 'warning',
...
function eliminar() {
    ...
    var parametros = {
        "pk_presentacion": $("#pk_presentacion").val()
    };

    $.ajax({
        data: parametros,

        url: 'servicios/eliminarPresentacion.php',
