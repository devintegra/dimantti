                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="d-flex gap-2">
                                <a href="agregarRuta.php"><button type="button" class="btn btn-social-icon-text btn-add"><i class='bx bx-plus'></i>Nueva ruta</button></a>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive overflow-hidden">
                                <table id='dtEmpresa' class='table table-striped text-center'>
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = $rrutas->fetch_assoc()) {

                                            echo <<<HTML
                                                <tr class='odd gradeX'>
                                                    <td>
                                                        <a href='editarRuta.php?id=$row[pk_ruta]'>$row[clave]</a>
                                                    </td>
                                                    <td>
