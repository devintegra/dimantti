                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="agregarProveedor.php"><button type="button" class="btn btn-social-icon-text btn-add"><i class='bx bx-plus'></i>Nuevo proveedor</button></a>
                        </div>
                        ...
                        <div class="table-responsive overflow-hidden">
                            <table id="dtEmpresa" class="table table-striped">
                                ...
                                <tbody>
                                    <?php
                                    $eusuario = "SELECT * FROM ct_proveedores WHERE estado = 1";
                                    ...
                                    while ($row = $resultado->fetch_assoc()) {
                                        ...
                                        $ph_number = preg_replace("/[^0-9]/", "", $number);

                                        $whats = "https://wa.me/521$ph_number";

                                        echo <<<HTML
                                            <tr class="odd gradeX">
                                                <td><a style='text-decoration:none' href='editarProveedor.php?id=$row[pk_proveedor]'>$row[rfc]</a></td>
                                                <td><a style='text-decoration:none' href='editarProveedor.php?id=$row[pk_proveedor]'>$row[nombre]</a></td>
                                                <td><a style='text-decoration:none' href='$whats' target='_blank'>$row[telefono]</a></td>
                                            </tr>
                                        HTML;
                                    }
                                    ?>
