...
//ENCABEZADO
#region
$qentrada = "SELECT * FROM tr_ventas WHERE pk_venta = $id";
...
//CLIENTE
#region
$qcliente = "SELECT * FROM ct_clientes WHERE pk_cliente = $entrada_fk_cliente";
...
if (!$venta_detalle_registros = $mysqli->query("SELECT COUNT(*) as registros FROM tr_abonos WHERE fk_factura = $id AND origen = 1 AND estado = 1")) {
...
$parrafo_header = <<<HTML
    <table border="0" cellpadding="1">
        <tr>
            <td colspan="2">
                <h3 style="text-align: center;">ABONOS VENTA #$id</h3>
...
//REGISTROS
#region
$qentradasd = "SELECT * FROM tr_abonos WHERE fk_factura = $id AND origen = 1 AND estado = 1 ORDER BY pk_abono";
