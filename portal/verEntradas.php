    ...
    <div class="main-panel">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Entradas desde compras</h4>
                        ...
                        <div class="table-responsive overflow-hidden" id="tabla">
                            <table id='dtEmpresa' class='table table-striped'>
                                ...
                                <tbody>
                                    ...
                                    $eusuario = "SELECT tr_entradas.*,
                                            ct_sucursales.nombre as sucursal,
                                            rt_sucursales_almacenes.nombre as almacen
                                        FROM tr_entradas, ct_sucursales, rt_sucursales_almacenes
                                        WHERE tr_entradas.estado = 1
                                        AND tr_entradas.fk_compra > 0$flsucursal
                                        AND ct_sucursales.pk_sucursal = tr_entradas.fk_sucursal
