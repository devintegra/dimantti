...
$qabonos = "SELECT tra.*,
    ...
    WHERE tra.origen = 4
    AND tra.fk_factura = $pk_prestamo
    AND tra.estado = 1";

$mysqli->next_result();
if (!$rpagos = $mysqli->query($qabonos)) {
...
<body>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title">Abonos del prestamo</h4>
                            <h4 class="card-title"> <span class="badge-warning-integra">Saldo actual: $ <?php echo $saldof ?> </span></h4>
                            <?php
                            echo <<<HTML
                                <input type='hidden' id='pk_prestamo' name='text-input' value='$pk_prestamo'>
                                <input type='hidden' id='fk_usuario' name='text-input' value='$usuario'>
                                <input type='hidden' id='saldo' name='text-input' value='$saldot'>
                                <input type='hidden' id='monto_abono' name='text-input' value='$monto_abono'>
                            HTML;
                            ?>
                        </div>
                        <form class="forms-sample" action="" method="post" enctype="multipart/form-data" id="formuploadajax">
                            ...
                            echo <<<HTML
                                <div class="filter-box">
                                    <div>
                                        <p class="d-flex align-items-center gap-2"> <i class="bx bx-user-circle fs-4"></i> <span class="fw-bold">Solicitante: </span>$empleado</p>
                                        <p class="d-flex align-items-center gap-2"> <i class="bx bx-calendar fs-4"></i> <span class="fw-bold">Fecha: </span>$fecha_creacion</p>
                                        <p class="d-flex align-items-center gap-2"> <i class="bx bx-coin-stack fs-4"></i> <span class="fw-bold">Monto: </span>$$monto</p>
                                        <p class="d-flex align-items-center gap-2"> <i class="bx bx-coin fs-4"></i> <span class="fw-bold">Monto de cada abono: </span>$$monto_abono</p>
                                        <p class="d-flex align-items-center gap-2"> <i class="bx bx-hash fs-4"></i> <span class="fw-bold">Pagos: </span>$cantidad_pagos</p>
                                        <p class="d-flex align-items-center gap-2"> <i class="bx bx-calendar fs-4"></i> <span class="fw-bold">Frecuencia: </span>$frecuencia</p>
                                    </div>
                                </div>
                            HTML;
                            ?>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <?php
                                        echo <<<HTML
                                            <input type="number" class="form-control" id="monto" name="monto" value="$monto_abono" placeholder="Monto" autocomplete="off">
                                        HTML;
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select id='fk_pago' class="form-control">
                                            ...
                                            <?php
                                            while ($rowt = $rsp_get_pagos->fetch_assoc()) {
                                                echo "<option value='$rowt[pk_pago]' data-comision='$rowt[comision]'>$rowt[nombre]</option>";
                                            }
                                            ?>
                                        </select>
                            ...
                            <button id="guardar" type="button" class="btn btn-success-dast mx-2"><i class="fa fa-save mx-2"></i>Guardar</button>
    ...
    <script src="custom/agregarPrestamoPago.js"></script>
